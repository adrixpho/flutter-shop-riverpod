...
enum PasswordError { empty, length, format, notSame }
...
class Password extends FormzInput<String, PasswordError> {
  ...
  const Password.pure({this.passwordReference}) : super.pure('');

  // Call super.dirty to represent a modified form input.
  const Password.dirty(String value, {this.passwordReference})
      : super.dirty(value);
  ...
  String? get errorMessage {
    ...
    if (displayError == PasswordError.notSame) {
  ...
  PasswordError? validator(String value) {
    ...
    if (passwordReference != null) {
      if (passwordReference! != value) return PasswordError.notSame;
    }
